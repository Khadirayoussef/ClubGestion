...
<%
    // Retrieving the facility ID from the request parameter and parsing it to int
        ...
        <form action="updateMember" method="post">
            ...
            <div class="form-group">
                ...
                <select id="sub" name="sub">
                    <c:forEach var="sub" items="${cotisations}">
                        <option value="${sub.id_Cotisation}">${sub.id_Cotisation}</option>
                    </c:forEach>
                </select>
            </div>
            <input type="hidden" name="idMember" value="<%=memberId%>">
            <div class="form-group">
                <label for="group">Group:</label>
                <select id="group" name="group">
                    <c:forEach var="group" items="${groups}">
                        <option value="${group.id_group}">Group Category: ${group.categorie} / Trainer: ${group.entraineur.nom} ${group.entraineur.prenom}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="form-group">
                ...
                <select id="sport" name="sport">
                    <c:forEach var="sport" items="${sports}">
                        <option value="${sport.idSport}">Sport: ${sport.nomSprot}</option>
                    </c:forEach>
                </select>
            </div>
