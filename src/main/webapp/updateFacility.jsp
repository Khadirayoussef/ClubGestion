...
<%
    ...
    System.out.println("Facility ID: " + facilityId); // Add this line for debugging
%>
...
<div class="main-panel">
    <div class="form-container sign-up-container">
        <form action="updateFacility" method="post">
            ...
            <input type="text" placeholder="Facility Name" name="name" />
            <input type="hidden" name="facilityId" value="<%= facilityId %>">
            <select name="sport">
                <c:forEach var="sport" items="${sports}">
                    <option value="${sport.idSport}">${sport.nomSprot}</option>
                </c:forEach>
            </select>
            <select name="access">
